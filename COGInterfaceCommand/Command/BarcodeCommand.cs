        ...
        public void GetBarcodes()
        {
            try
            {
                ...
                foreach(FileInfo file in files)
                {
                    try
                    {
                        GetBarcodes(file.FullName); //file.FullName
                        //GetBarcodes("D:\\Projects\\ProjectVu\\ACFC\\COGInterfaceCommand\\bin\\Debug\\Downloads\\COG_BARCODE_ACFC_201911090445.TXT");
