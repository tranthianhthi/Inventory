        ...
        public void GetPricingItems()
        {
            ...
            try
            {
                ...
                foreach (FileInfo file in files)
                {
                    try
                    {
                        GetPricingItems(file.FullName); //file.FullName
                        //GetPricingItems("D:\\Projects\\ProjectVu\\ACFC\\COGInterfaceCommand\\bin\\Debug\\Downloads\\COG_PRICING_ACFC_201911090445.TXT");                        
