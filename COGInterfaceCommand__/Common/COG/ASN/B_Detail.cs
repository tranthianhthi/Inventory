...
namespace COGInterfaceCommand.Common.COG.ASN
{
    public class B_Detail : ICOGItem 
    {
        ...
        public string checkDetailError(B_Detail detail)
        {
            ...
            if (ASN_Number == "") detailerrormess = detailerrormess + "ASN Number can not be null.";
            if (HBL_Number == "") detailerrormess = detailerrormess + "HBL_Number can not be null.";
            if (order_number == "") detailerrormess = detailerrormess + "order_number can not be null.";          
            if (COGFileName == "") detailerrormess = detailerrormess + "COGFileName can not be null.";
